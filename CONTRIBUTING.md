...
```bash
pipx install --force "plugin-scanner==2.2.102"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `48e669cfaa0ec63fbd61db8660dec3210ffdc276ce3ffbd16932aac359f3b34e`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.2.102"
