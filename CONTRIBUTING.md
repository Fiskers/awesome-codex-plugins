...
```bash
pipx install --force "plugin-scanner==2.2.101"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `3fdf06313f0985637f1e8690845e8a03c18fccae462cfb7720de59c819a44658`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.2.101"
