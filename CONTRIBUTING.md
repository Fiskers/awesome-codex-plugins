...
```bash
pipx install --force "plugin-scanner==2.2.100"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `7b68ef4ee5d017ad183d85cf1fe4ec359891c54757127d2bc49a98016b7167f7`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.2.100"
