...
```bash
pipx install --force "plugin-scanner==2.2.104"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `94e13aaf89f4ab0d465b78c6dbfb85636c0c71924ca9f62bc07709334c185932`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.2.104"
