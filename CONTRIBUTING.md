...
```bash
pipx install --force "plugin-scanner==2.2.105"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `04099ed818da9860e93c2bd9395c9363c89f29e0022e13a1543a524ec74fda64`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.2.105"
