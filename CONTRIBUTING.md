...
```bash
pipx install --force "plugin-scanner==2.2.108"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `0a41671cb75e6dfec57466d55aa8813157206508bf9c85dc2f7ccebb85082684`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.2.108"
